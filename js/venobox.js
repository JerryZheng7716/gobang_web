...
(function($){
    ...
    function loadVimeo(autoplay){
      ...
      content.html('<iframe class="venoframe" webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder="0" src="//player.vimeo.com/app/'+videoid+stringAutoplay+'"></iframe>');
      updateoverlay();
    }
